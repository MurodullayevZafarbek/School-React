...
function Workers(props) {
   ...
   const change = (index) => {
      ...
      const sliderElements = document.querySelectorAll("#slider>div");
      ...
      <div className="Workers" id="about_us">
         <div className="container">
            <div className="content">
               <h1 className="Prime_Text">Bizning Xodimlarimiz</h1>
                        ...
                        index === 0 ?
                           <div className="active12" key={index} onClick={() => { change(index) }}  >
                              <div className="text1">
                                 ...
                                 <button className="btn_prime">Xabar jo'natish</button>
                              </div>
